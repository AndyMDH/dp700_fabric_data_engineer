...
Skills measured as of **July 21, 2026** (the version effective at time of writing — exam refreshes annually, so re-check the [study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/dp-700) before your exam date).

All three domains are weighted **30–35%** each — there is no "light" section on this exam.
